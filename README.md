...
I have tested this on both Linux (Fedora 32) and Windows (Windows 10) machines - With Windows 10, this [guide](https://geekflare.com/ansible-installation-windows/) describes how to install Ansible using Windows Subsystem for Linux. If you run into any issues, please let me know!
